...
class MeallenniumSharedPreferences(val context: Context) {
    ...
    fun clearValues() {
        storeString(UserManager.FIRST_NAME_KEY, null)
        storeString(UserManager.LAST_NAME_KEY, null)
        storeString(UserManager.EMAIL_KEY, null)
        storeString(UserManager.LOGIN_METHOD_KEY, null)
    }
